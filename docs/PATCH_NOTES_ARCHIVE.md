...
Older entries, moved out of `src/app/content/patchNotes.md` (the in-app
Patch Notes modal) so that modal only shows the current batch. Not
rendered anywhere in the app — reference only.
